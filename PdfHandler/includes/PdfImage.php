...
class PdfImage {
	...
	public function retrieveMetaData() {
		...
		if ( $wgPdfInfo ) {
			...
			$cmdMeta = "pdfinfo.exe -meta " . $this->mFilename;
		...
		if ( isset( $wgPdftoText ) ) {
			...
			$pdftotextoutputpath = "C:\Windows\Temp\pdftotext" . rand(1, 99999) . ".txt";
			$cmd = "pdftotext.exe " . $this->mFilename . " " . $pdftotextoutputpath ; 
